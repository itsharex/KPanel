...
- `91d1912`：修复内置浏览器起始页滚动条位置；
- `bc45e15`：提升内置浏览器文字、图标与快捷入口清晰度；
- `e0663ca`：所有地区的关键词搜索统一提交到 `www.bing.com/search`；
...
- Bing 或搜索结果网站未来仍可能通过 CSP、`X-Frame-Options` 或其他策略拒绝 iframe；界面保留“用系统浏览器打开”回退；
